...
const GOOGLE_REVIEWS = [
  ...
  { name: "John S.", avatar: "JS", rating: 5, date: "2025-01-15", text: "Amazing monument in Cochabamba. The statue is beautifully crafted and the surrounding area is peaceful and well-maintained." },
  { name: "Carlos R.", avatar: "CR", rating: 4, date: "2024-12-20", text: "Un lugar sagrado en Cochabamba. El monumento es imponente y transmite un mensaje de paz y unidad." },
  { name: "李明", avatar: "李", rating: 5, date: "2024-11-10", text: "和谐基督纪念碑非常壮观，雕塑精美，周围环境宁静，是科恰班巴重要的宗教和文化地标。" },
  { name: "Ana P.", avatar: "AP", rating: 5, date: "2024-10-25", text: "Hermoso monumento en Cochabamba. Muy recomendable visitar. El mensaje de concordia es inspirador." },
  { name: "Robert W.", avatar: "RW", rating: 4, date: "2024-09-15", text: "Beautiful religious monument. Great place for reflection and photography. The statue is well-crafted and the location is peaceful." }
];
